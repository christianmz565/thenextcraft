...
export default function HomePage() {
  return (
    <main className="bg-background">
      <header className="flex h-20 items-center justify-between border-b bg-background px-4 md:px-8 lg:px-12">
        <BrandMark />
      ...
      <div className="relative h-[calc(200svh-5rem)]">
        ...
        <div className="absolute inset-x-0 top-[calc(100svh-5rem)] h-svh overflow-hidden">
